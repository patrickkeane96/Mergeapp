// Script to insert all sample data into the mergers table
...
async function insertAllData() {
  try {
    console.log('Inserting all sample data into the mergers table...');

    // Insert sample data one by one to avoid potential issues
    for (const record of sampleData) {
      ...
      if (error) {
        ...
        console.log(`Successfully inserted record: ${record.name}`);
      }
    }
